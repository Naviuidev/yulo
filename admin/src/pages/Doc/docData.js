  ...
  // ── Setup ──────────────────────────────────────────────
  {
    ...
    body: [
      ...
      },
      {
        type: 'creds',
        items: [
          { role: 'Admin', email: '992201351702', password: 'Hosur@1998' },
    ...
    body: [
      {
        ...
        items: [
          ...
          { label: 'Dashboard (overview, analytics, revenue, reports)', path: 'admin/src/pages/Dashboard/Dashboard.jsx  →  /' },
          ...
          { label: 'Brands & Sections (incl. Banners)', path: 'admin/src/pages/Brands/Brands.jsx  →  /brands' },
          { label: 'Inventory', path: 'admin/src/pages/Inventory/Inventory.jsx' },
          { label: 'Offers (strips, card, coupons)', path: 'admin/src/pages/OfferStrips/OfferStrips.jsx  →  /offer-strips' },
...
php backend/database/seed.php`,
  ...
  },
  {
    ...
    tags: ['banners', 'admin', 'api', 'done'],
    summary: 'Hero backgrounds are now managed via Admin → Banners (max 3 Home).',
    body: [
      {
        type: 'checklist',
        items: [
          'DONE: GET /banners?position=home&limit=3',
          'DONE: HeroBanner.jsx slides only the background; logo/tagline/CTAs stay fixed',
          'DONE: Admin → Banners enforces max 3 active Home banners',
          'Optional next: image upload to backend/uploads/banners/ (paste URL works now)',
          'Optional next: wire FeaturedCollection / other sections to banners',
        ],
      },
    ],
  },

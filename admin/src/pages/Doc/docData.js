    ...
    body: [
      {
        ...
        items: [
          ...
          { label: 'Banners + Featured Collection', path: 'admin/src/pages/Banners/Banners.jsx  →  /banners' },
          { label: 'Offers (Strips + Offer Card)', path: 'admin/src/pages/OfferStrips/OfferStrips.jsx  →  /offer-strips' },
